...
//     return ['ALL', ...new Set(products.map((item) => item.typeName))]
//   }, [products])
...
//           <input
//             type="text"
//             placeholder="Ten giay, thuong hieu, mo ta..."
//             value={searchText}
...
//             className="w-full rounded-2xl cursor-pointer border border-slate-200 px-4 py-3"
//           >
...
//             <option value="2">1 - 2 trieu</option>
//             <option value="3">2 - 3 trieu</option>
//             <option value="4">3 - 5 trieu</option>
//             <option value="5">Tren 5 trieu</option>
//           </select>
//         </div>
...
//           <button
//             onClick={onReset}
//             className="w-full rounded-xl mb-1 bg-black px-4 py-3 font-bold text-white hover:bg-orange-600 duration-100 cursor-pointer"
//           >
//             Xoa loc
//           </button>
//         </div>
